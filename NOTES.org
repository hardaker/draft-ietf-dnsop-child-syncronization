...
**** TODO - "...it may..." is marginally ambiguous
**** TODO - "...existence of and value of..." was sufficiently clumsy to cause
      re-reading
**** TODO - "as appropriate" always rings an alarm bell with me because it
      actually says nothing :-)  (I may be wrong about "...depending on
      local policy" which would:
      - prove my point
      - allow you to substitute your own text.

**** TODO The same paragraph appears in the Introduction.
...
**** TODO Also "child DNS operators" made me giggle unmercifully.
    Maybe "operators of child DNS zones"?
**** TODO In general, the inclusion of "zone" after "DNS" will help clarify.

    ---

**** TODO 2.1.1.2 and 2.1.1.2.1.
