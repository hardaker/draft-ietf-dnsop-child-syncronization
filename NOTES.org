...
**** DONE - "...existence of and value of..." was sufficiently clumsy to cause
     ...
     :END:
      re-reading
      + changed to "The existence of a CSYNC record and its value can
...
**** DONE - "as appropriate" always rings an alarm bell with me because it
	...
	+ changed to the same text in both places
...
**** DONE Also "child DNS operators" made me giggle unmercifully.
    ...
    + good point.  And I'm happy you enjoyed any humor you got out of
      it :-)

**** WONTDO In general, the inclusion of "zone" after "DNS" will help clarify.

     + I'm not sure that's actually wise in most other places.  Is
...
***** DONE DISCUSS:
      ...
      + Good point; changed to "Specifically: a parental agent must not copy data blindly
	and must understand the semantics associated with an bit in
	the Type Bit Map field that has been set to 1."


      + New IANA text: For new assignments to be made to this
...
*** DONE Joel Jaeggli
    ...
    :END:
      ...
      + this was reissued already right?
...
******* TODO Good document. A few simple comments:
...
******* TODO I think you reversed this sentence. Better would be:
...
******* TODO Sections 4.2, 4.3, and 4.4: The MAYs in there MAY be inappropriate. The
